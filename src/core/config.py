...
MODEL_PATH = "models/yolov26s.pt" # The Name of the Model to be used for Object Detection
...
OCCLUSION_GRACE_FRAMES = 5   # tolerate this many consecutive frames where an in-progress or already-confirmed hold's object isn't detected at all
RELEASE_CONFIRM_FRAMES = 4   # consecutive CONFIRMED-separated frames