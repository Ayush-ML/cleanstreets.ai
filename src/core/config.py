...
MODEL_PATH = "models/yolo26s.pt" # The Name of the Model to be used for Object Detection
...
MIN_HOLD_FRAMES = 6 # Number of frames a person has to be holding an object before it is actually considored holding
OVERLAP_THRESHOLD = 0.15 # Minimum IOU Score for Bounding box based Overlapping/Holding
WRIST_PROXIMITY_RATIO = 0.75 #  Distance of the Wrist to the center of the Object Threshold
...
DESCENT_THRESHOLD = 0.08 # Average of dy in a frame as a ratio of the objects height
GROUND_LINE_RATIO = 0.80 # 80 percent of the frame counts as not ground, rest as ground
STILLNESS_RADIUS_PERCENT = 0.02 # Percent Object should stay within of the frames width to count as stopped
SETTLED_CONFIRMATION_FRAMES = 12 # Number of Frames the position of the Object must stop moving in order to register it as settled
PERSON_EXIT_FRAMES = 20 # No of Frames person must be absent before triggering littering
...
REVIEW_TITLE = "CleanStreets AI — Incident Review" # The Title of the Incident in the Streamlit Dashboard
OCCLUSION_GRACE_FRAMES = 8   # tolerate this many consecutive frames where an in-progress or already-confirmed hold's object isn't detected at all
RELEASE_CONFIRM_FRAMES = 5   # consecutive CONFIRMED-separated frames